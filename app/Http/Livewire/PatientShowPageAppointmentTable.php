...
class PatientShowPageAppointmentTable extends LivewireTableComponent
{
    ...
    public function query(): Builder
    {
        ...
        if (getLogInUser()->hasRole('doctor')) {
            $query = Appointment::with(['doctor.user', 'doctor.reviews'])->where('patient_id', '=', $this->patientId)->whereDoctorId(getLogInUser()->doctor->id);   
        }
    ...
    public function render()
    {
        ...
        return view('livewire-tables::'.config('livewire-tables.theme').'.datatable')
            ->with([
                ...
                'filterComponent' => 'patients.appointment_filter',
