                        ...
                        <div class="card-header border-0 pt-5">
                            ...
                            <div class="ms-0 ms-md-2">
                                <div class="dropdown d-flex align-items-center me-4 me-md-5">
                                    <button
                                            class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" id="filterBtn"
...
">{{$patient->user->fullname}}</a>
                                                    ...
                                                    <td class="text-center text-muted fw-bold">
                                                        ...
                                                        {{ \Carbon\Carbon::parse($patient->user->created_at)->isoFormat('DD MMM YYYY h:m A')}}
                                                        </span>
                                                    </td>
                                                </tr>
                                            @empty
