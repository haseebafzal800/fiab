<div class="ms-auto">
    <div class="dropdown d-flex align-items-center me-4 me-md-5">
        <button class="btn btn btn-icon btn-primary text-white dropdown-toggle hide-arrow ps-2 pe-0" type="button"
                id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" data-bs-auto-close="outside">
            <p class="text-center">
        ...
        <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
            ...
            <div class="p-5">
                <div class="mb-5">
                    ...
                    {{ Form::select('status', filterLangChange($status), $filter, ['class' => 'io-select2 form-select', 'data-control'=>"select2", 'id' => 'enquiriesStatus']) }}
                </div>
