        ...
        <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton1">
            ...
            <div class="p-5">
                ...
                <div class="mb-5">
                    ...
                    {{ Form::select('status', filterLangChange($appointmentStatus), $filter['status'], ['class' => 'form-select io-select2', 'data-control'=>"select2", 'id' => 'patientShowPageAppointmentStatus']) }}
                </div>
